...
1. [Dynamic pack generators](#1-dynamic-pack-generators)  
  ...
  a. [The `@range` operator](#b-the-range-operator)  
  a. [For-expressions](#c-for-expressions)  
1. [Dynamic pack consumers](#2-dynamic-pack-consumers)  
  a. [Expansion expressions](#a-expansion-expressions)  
  a. [List comprehensions](#b-list-comprehensions)  
  a. [Functional fold expressions](#c-functional-fold-expressions)  
  a. [For-range-initializers](#d-for-range-initializers)  
...
1. [Circle vs C++ ranges](#circle-vs-c-ranges)  
  ...
  a. [any_of, all_of, none_of](#any_of-all_of-none_of)  
  a. [count](#count)  
  a. [count_if](#count_if)  
  a. [for_each on sequence containers](#for_each-on-sequence-containers)  
  a. [for_each on associative containers](#for_each-on-associative-containers)  
  a. [is_sorted](#is_sorted)  
  a. [Filter and transform](#filter-and-transform)  
  a. [Generate ints and accumulate](#generate-ints-and-accumulate)  
