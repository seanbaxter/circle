...
$ ./virtual
kernel: creating derived1_t and upcasting to base_t*:
  derived1_t::derived1_t() constructor called
  derived1_t::func() called: Hello

kernel: typeid of the base_t: 10derived1_t

kernel: dynamic_cast from base_t:
  dynamic_cast<derived1_t>(base) = 0x7ff0c3bff920
  dynamic_cast<derived2_t>(base) = (nil)

kernel: calling the deleting dtor on base:
  derived1_t::~derived1_t() destructor called

kernel: creating derived3_t and upcasting to derived1_t:
  derived1_t::derived1_t() constructor called
  derived2_t::derived2_t() constructor called
  derived3_t::derived3_t() constructor called

kernel: typeof of the derived1_t: 10derived3_t

kernel: dynamic_cast from derived1_t:
  dynamic_cast<derived2_t>(derived1) = 0x7ff0c3bff930
  dynamic_cast<derived3_t>(derived1) = 0x7ff0c3bff920

kernel: calling the deleting dtor on derived1:
  derived3_t::~derived3_t() destructor called
  derived2_t::~derived2_t() destructor called
  derived1_t::~derived1_t() destructor called
```
