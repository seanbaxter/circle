...
1. [Program 2: TACO as a compile-time library](#program-3--taco-as-a-compile-time-library) 
1. [Program 3: Code generation from TACO IR](#program-4--code-generation-from-taco-ir)  
...
[**taco1.cxx**](https://www.github.com/seanbaxter/circle/gems/taco1.cxx)
```cpp
#include "util.hxx"
#include <taco.h>
...
[**taco2.cxx**](https://www.github.com/seanbaxter/circle/gems/taco2.cxx)
```cpp
#include "util.hxx"
#include <taco.h>
...
[**taco2.cxx**](https://www.github.com/seanbaxter/circle/gems/taco1.cxx)
```cpp
...
[**taco3.cxx**](https://www.github.com/seanbaxter/circle/gems/taco3.cxx)
```cpp
